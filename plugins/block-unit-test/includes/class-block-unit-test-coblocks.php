...
class Block_Unit_Test_CoBlocks {
	...
	public function coblocks_content() {
		...
		$content .= '
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Accordions', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Media Card', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Alerts', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Pricing Tables', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Click to Tweet', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Author Profile', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Social Sharing', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Shape Divider', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:heading -->
			<h2>' . esc_html__( 'Features', 'block-unit-test' ) . '</h2>
			<!-- /wp:heading -->
